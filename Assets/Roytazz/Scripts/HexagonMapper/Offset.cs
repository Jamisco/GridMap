...
{
    /// <summary>
    /// Describes the position of a Hexagon in a Offset AxialCoordinates based Hexagon Grid
    /// </summary>
    [Serializable]
    public readonly partial struct Offset : IEquatable<Offset>, IEqualityComparer<Offset>
    {
        ...
        public Offset(float x, float y) : this((int)x, (int)y) { }

        //private readonly float X;
        //private readonly float Y;
        /*public Offset(float X, float Y) : this() {
            this.X = X;
            this.Y = Y;
        }*/
